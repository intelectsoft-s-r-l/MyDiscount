...
abstract class LocalRepository {
  ...
  /// Wen update [Profile] data it's save old information to have possibility to 
  /// restore data to initial state  
  void saveOldProfileData({required Profile profile});
  /// Return old [Profile] data when need to restore data on profile page
  Profile getOldProfileData();
  /// Delete old [Profile] when data is send to server 
