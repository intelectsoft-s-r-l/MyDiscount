...
class SettingsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    void _changeLanguage(Language language) async {
      final Locale _locale = await AppLocalizations.of(context).setLocale(language.languageCode);
        ...
        child: ChangeNotifierProvider<FirebaseCloudMessageService>.value(
          ...
          child: ChangeNotifierProvider<NewsSettings>.value(
            ...
            child: Column(
              children: [
                Consumer2(
                  builder: (context, FirebaseCloudMessageService provider, NewsSettings provider2, _) {
                    return Column(
                      children: [
                        ListTile(
                          title: Text(
                    ...
                    trailing: FutureBuilder<Language>(
                      ...
                      builder: (context, snapshot) => DropdownButton<Language>(
                        ...
                        hint: Container(
                            ...
                            height: 20,
                            width: 120,
                            child: snapshot.hasData ? Text('${snapshot.data.name}') : Container()),
