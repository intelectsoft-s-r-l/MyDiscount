...
import 'package:IsService/service_client.dart' as _i21;

import 'aplication/auth/auth_bloc.dart' as _i23;
import 'aplication/auth/sign_in/sign_form_bloc.dart' as _i31;
import 'aplication/phone_validation_bloc/phone_validation_bloc.dart' as _i27;
import 'aplication/profile_bloc/profile_form_bloc.dart' as _i28;
...
import 'domain/repositories/is_service_repository.dart' as _i25;
import 'domain/repositories/local_repository.dart' as _i18;
import 'infrastructure/auth_repository_impl.dart' as _i30;
import 'infrastructure/core/services_injectable.dart' as _i32;
import 'infrastructure/is_service_impl.dart' as _i26;
...
import 'services/shared_preferences_service.dart' as _i22; // ignore_for_file: unnecessary_lambdas
...
_i1.GetIt $initGetIt(_i1.GetIt get, {String environment, _i2.EnvironmentFilter environmentFilter}) {
  ...
  gh.lazySingleton<_i9.DataConnectionChecker>(() => serviceInjectableModule.connectionChecker);
  gh.lazySingleton<_i10.DeviceInfoPlugin>(() => serviceInjectableModule.deviceinfo);
  gh.lazySingleton<_i11.DeviceInfoService>(() => _i11.DeviceInfoService(get<_i10.DeviceInfoPlugin>()));
  ...
  gh.lazySingleton<_i14.FlutterLocalNotificationsPlugin>(() => serviceInjectableModule.flutterLocalNotification);
  ...
  gh.lazySingleton<_i17.LocalNotificationsService>(() => _i17.LocalNotificationsService(get<_i14.FlutterLocalNotificationsPlugin>()));
  ...
  gh.lazySingleton<_i24.FirebaseCloudMessageService>(
      () => _i24.FirebaseCloudMessageService(get<_i13.FirebaseMessaging>(), get<_i17.LocalNotificationsService>(), get<_i22.SharedPref>()));
  gh.lazySingleton<_i29.AuthRepository>(() => _i30.AuthRepositoryImpl(get<_i16.GoogleSignIn>(), get<_i12.FacebookLogin>(), get<_i25.IsService>(), get<_i18.LocalRepository>()));
  gh.lazySingleton<_i25.IsService>(() => _i26.IsServiceImpl(get<_i21.ServiceClient>(), get<_i20.NetworkConnection>(), get<_i18.LocalRepository>(), get<_i15.Formater>()));
  gh.factory<_i23.AuthBloc>(() => _i23.AuthBloc(get<_i18.LocalRepository>()));
  gh.factory<_i27.PhoneValidationBloc>(() => _i27.PhoneValidationBloc(get<_i25.IsService>(), get<_i18.LocalRepository>()));
  gh.factory<_i28.ProfileFormBloc>(() => _i28.ProfileFormBloc(get<_i18.LocalRepository>(), get<_i25.IsService>()));
  gh.factory<_i31.SignFormBloc>(() => _i31.SignFormBloc(get<_i29.AuthRepository>(),get<_i20.NetworkConnection>()));
  return get;
}

class _$ServiceInjectableModule extends _i32.ServiceInjectableModule {}
